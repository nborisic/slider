...
import Generic from '../../components/Global/generic';
...
export default class Dashboard extends Component {
  ...
  constructor() {
    ...
    this.fadeBox = this.fadeBox.bind(this);
    ...
    return (
      <div className='Dashboard' key='Dashboard'>
        ...
        {/*  <ReactCSSTransitionGroup
          ...
          >
            <div className='initial'> animiraj se! </div>
        </ReactCSSTransitionGroup>
        */}
        <h2>Examples</h2>
        <div className='container'>
          <TransitionGroup >
            { this.state.showBox && <Generic data='a' /> }
            { !this.state.showBox && <Generic data='a' /> }
          </TransitionGroup>
        </div>
        <div className='clearfix' />
        <button className='toggleBox' onClick={ this.toggleBox } > toggle </button>
